...
The professor provided the implementation of "Presentable" and of "SequenceSearch" as well as some of
the tests for the project, we implemented "SequenceSearchImpl" which extends the SequenceSearch object.
